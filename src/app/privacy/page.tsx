...
export default function PrivacyPage() {
    return (
        <LegalLayout title="Privacy Policy" date={new Date().toLocaleDateString()}>
            <p className="lead">
                Your privacy is our priority. We process your data locally in your browser to ensure maximum security.
            </p>
            ...
            <h3>5. Contact Us</h3>
            <p>
                If you have any questions about this Privacy Policy, please contact us at support@textgauge.com (placeholder).
            </p>
        </LegalLayout>
    );
}

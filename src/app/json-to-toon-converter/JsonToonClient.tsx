...
Jane Smith, jane@example.com, Designer, 88`;
    ...
    // Custom action for direction toggle
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-emerald-100">Same data, fewer tokens, lower AI costs</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-3 gap-8 text-center">
                            <div>
                                <div className="text-3xl font-bold">~60%</div>
                                <div className="text-sm text-emerald-100">Fewer Tokens</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold">100%</div>
                                <div className="text-sm text-emerald-100">Lossless</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold">∞</div>
                                <div className="text-sm text-emerald-100">Conversions</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 text-sm text-slate-600 dark:text-slate-300">
                        <div>
                            <h3 className="font-bold text-base mb-2 text-slate-900 dark:text-white flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> AI-Optimized Format
                            </h3>
                        ...
                        <div>
                            <h3 className="font-bold text-base mb-2 text-slate-900 dark:text-white flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> Tabular Arrays
                            </h3>
                            <p className="leading-relaxed">
                        ...
                        <div>
                            <h3 className="font-bold text-base mb-2 text-slate-900 dark:text-white flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> Bidirectional Conversion
                            </h3>
                            <p className="leading-relaxed">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                            ...
                            <ul className="space-y-2 text-slate-600 dark:text-slate-300 text-sm">
                                <li className="flex items-start gap-2">
                                    <ArrowRight className="text-purple-500 mt-0.5 flex-shrink-0" size={16} />
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-slate-200 dark:border-slate-700">
                                    ...
                                    <th className="text-left py-3 px-4 font-semibold text-emerald-600 dark:text-emerald-400">TOON</th>
                                </tr>
                            </thead>
                            <tbody className="text-slate-600 dark:text-slate-300">
                                <tr className="border-b border-slate-100 dark:border-slate-800">
                                    ...
                                    <td className="py-3 px-4 text-emerald-600 dark:text-emerald-400 font-semibold">40-70%</td>
                                </tr>
                                <tr className="border-b border-slate-100 dark:border-slate-800">
                                    <td className="py-3 px-4">API Costs</td>
                                    <td className="py-3 px-4">Higher</td>
                                    <td className="py-3 px-4 text-emerald-600 dark:text-emerald-400 font-semibold">30-60% savings</td>
                                </tr>
                                <tr className="border-b border-slate-100 dark:border-slate-800">
                                ...
                                <tr className="border-b border-slate-100 dark:border-slate-800">
                                    ...
                                    <td className="py-3 px-4 text-emerald-600 dark:text-emerald-400 font-semibold">Improved</td>
                                </tr>
                                <tr>
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-xl p-6 border border-indigo-200 dark:border-indigo-800">
                                <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900 rounded-lg flex items-center justify-center mb-4">
                                    <TrendingDown className="text-indigo-600 dark:text-indigo-400" size={24} />
                                </div>
            ...
            <section className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 pb-16">
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/20 dark:to-purple-950/20 rounded-2xl border border-indigo-200 dark:border-indigo-800 p-6 text-center">
                    <p className="text-slate-700 dark:text-slate-300 font-medium text-base">
                        JSON to TOON Converter works on <strong>Windows</strong>, <strong>Mac</strong>, <strong>Linux</strong>, <strong>Chrome</strong>, <strong>Firefox</strong>, <strong>Safari</strong> and <strong>Edge</strong> – and it&apos;s <strong className="text-indigo-600 dark:text-indigo-400">Free</strong>.
                    </p>
                </div>
            </section>
        </div>
